...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  AuthInteraction: 'pi-ai login interaction is owned by @earendil-works/pi-ai; the store contract is packages/llm/llm-oauth/README.md',
  Credential: 'pi-ai stored credential is owned by @earendil-works/pi-ai; the store contract is packages/llm/llm-oauth/README.md',
  CredentialInfo: 'pi-ai credential metadata is owned by @earendil-works/pi-ai; the store contract is packages/llm/llm-oauth/README.md',
  LoginableProvider: 'OAuth-capable catalog row is owned by packages/llm/llm-oauth/README.md',
