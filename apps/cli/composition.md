...
The dsh-base bundle patch every profile applies first; mode bundles (dsh-web-app, dsh-headless, dsh-tui) and the user's profile layer patch over it.
...
flowchart LR
  ...
  plugin_dsh_base_llm_oauth["llm-oauth<br/>@deepseek-ai/dsh-llm-oauth"]
...
| `llm-oauth` | `@deepseek-ai/dsh-llm-oauth` |
